...
import { supabase, SUPABASE_ENV_OK } from '../lib/supabase'
  ...
  if (!SUPABASE_ENV_OK) {
    return (
      <div className="card" style={{ borderColor: '#ef4444' }}>
        ...
        <p className="muted">
          Set <code>VITE_SUPABASE_URL</code> and <code>VITE_SUPABASE_ANON_KEY</code> in Vercel →
